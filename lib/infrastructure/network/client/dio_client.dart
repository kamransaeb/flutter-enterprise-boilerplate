...
class DioClient {
  ...
  DioClient(this._appConfig, this._deviceInfoPlugin) {
    _dio = _createDio();
    _addInterceptors();
  }
  ...
  void _addInterceptors() {
    ...
    _dio.interceptors.addAll([
      HeaderInterceptor(_appConfig, _deviceInfoPlugin),
      AuthInterceptor(secureStorage: null),
      CacheInterceptor(cacheManager: null),
      RetryInterceptor(),
      ErrorInterceptor(),
      if (_appConfig.enableLogging) LoggingInterceptor(),
    ]);
  }
  ...
  Future<Response<T>> post<T>(
    ...
    try {
      ...
      logger.e('Post request failed $path', error: e);
      rethrow;
    }
  }
  ...
  Future<Response<T>> patch<T>(
    ...
    try {
      ...
      logger.e('Patch request failed $path', error: e);
      rethrow;
    }
  }
  ...
  Future<Response<T>> head<T>(
    ...
    try {
      ...
      logger.e('Head request failed $path', error: e);
      rethrow;
    }
  }
  ...
  Future<Response> download(
    ...
    String savePath,
    {
      ...
      try {
        ...
        logger.e('Download request failed $urlPath', error: e);
        rethrow;
      }
    }
    ...
    Future<Response<T>> upload<T>(
      ...
      try {
        ...
        logger.e('Upload request failed $path', error: e);
        rethrow;
      }
    }
