...
@override
String toString() {
  return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl, phoneNumber: $phoneNumber, emailVerified: $emailVerified, phoneVerified: $phoneVerified, roles: $roles, createdAt: $createdAt, updatedAt: $updatedAt, loggedInAt: $loggedInAt, isProfileCompleted: $isProfileCompleted, isActive: $isActive)';
}
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? firstName = freezed,Object? lastName = freezed,Object? avatarUrl = freezed,Object? phoneNumber = freezed,Object? emailVerified = null,Object? phoneVerified = null,Object? roles = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? loggedInAt = freezed,Object? isProfileCompleted = null,Object? isActive = null,}) {
...
as DateTime?,isProfileCompleted: null == isProfileCompleted ? _self.isProfileCompleted : isProfileCompleted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'email')  String email, @JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'phone_number')  String? phoneNumber, @JsonKey(name: 'email_verified')  bool emailVerified, @JsonKey(name: 'phone_verified')  bool phoneVerified, @JsonKey(name: 'roles')  List<String> roles, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'logged_in_at')  DateTime? loggedInAt, @JsonKey(name: 'is_profile_completed')  bool isProfileCompleted, @JsonKey(name: 'is_active')  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'email')  String email, @JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'phone_number')  String? phoneNumber, @JsonKey(name: 'email_verified')  bool emailVerified, @JsonKey(name: 'phone_verified')  bool phoneVerified, @JsonKey(name: 'roles')  List<String> roles, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'logged_in_at')  DateTime? loggedInAt, @JsonKey(name: 'is_profile_completed')  bool isProfileCompleted, @JsonKey(name: 'is_active')  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.email,_that.firstName,_that.lastName,_that.avatarUrl,_that.phoneNumber,_that.emailVerified,_that.phoneVerified,_that.roles,_that.createdAt,_that.updatedAt,_that.loggedInAt,_that.isProfileCompleted,_that.isActive);case _:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id')  String id, @JsonKey(name: 'email')  String email, @JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'phone_number')  String? phoneNumber, @JsonKey(name: 'email_verified')  bool emailVerified, @JsonKey(name: 'phone_verified')  bool phoneVerified, @JsonKey(name: 'roles')  List<String> roles, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'logged_in_at')  DateTime? loggedInAt, @JsonKey(name: 'is_profile_completed')  bool isProfileCompleted, @JsonKey(name: 'is_active')  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.email,_that.firstName,_that.lastName,_that.avatarUrl,_that.phoneNumber,_that.emailVerified,_that.phoneVerified,_that.roles,_that.createdAt,_that.updatedAt,_that.loggedInAt,_that.isProfileCompleted,_that.isActive);case _:
  return null;
...
class _User extends User {
  const _User({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'email') required this.email, @JsonKey(name: 'first_name') this.firstName, @JsonKey(name: 'last_name') this.lastName, @JsonKey(name: 'avatar_url') this.avatarUrl, @JsonKey(name: 'phone_number') this.phoneNumber, @JsonKey(name: 'email_verified') this.emailVerified = false, @JsonKey(name: 'phone_verified') this.phoneVerified = false, @JsonKey(name: 'roles') final  List<String> roles = const [], @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'logged_in_at') this.loggedInAt, @JsonKey(name: 'is_profile_completed') this.isProfileCompleted = false, @JsonKey(name: 'is_active') this.isActive = true}): _roles = roles,super._();
